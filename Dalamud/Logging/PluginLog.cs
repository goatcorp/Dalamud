...
namespace Dalamud.Logging
{
    ...
    {
        #region "Log" prefixed style methods
        ...
        public static void Log(string messageTemplate, params object[] values)
            => Logging.Internal.Log.Information($"[{Assembly.GetCallingAssembly().GetName().Name}] {messageTemplate}", values);
        ...
        public static void Log(Exception exception, string messageTemplate, params object[] values)
            => Logging.Internal.Log.Information(exception, $"[{Assembly.GetCallingAssembly().GetName().Name}] {messageTemplate}", values);
        ...
        public static void LogVerbose(string messageTemplate, params object[] values)
            => Logging.Internal.Log.Verbose($"[{Assembly.GetCallingAssembly().GetName().Name}] {messageTemplate}", values);
        ...
        public static void LogVerbose(Exception exception, string messageTemplate, params object[] values)
            => Logging.Internal.Log.Verbose(exception, $"[{Assembly.GetCallingAssembly().GetName().Name}] {messageTemplate}", values);
        ...
        public static void LogDebug(string messageTemplate, params object[] values)
            => Logging.Internal.Log.Debug($"[{Assembly.GetCallingAssembly().GetName().Name}] {messageTemplate}", values);
        ...
        public static void LogDebug(Exception exception, string messageTemplate, params object[] values)
            => Logging.Internal.Log.Debug(exception, $"[{Assembly.GetCallingAssembly().GetName().Name}] {messageTemplate}", values);
        ...
        public static void LogWarning(string messageTemplate, params object[] values)
            => Logging.Internal.Log.Warning($"[{Assembly.GetCallingAssembly().GetName().Name}] {messageTemplate}", values);
        ...
        public static void LogWarning(Exception exception, string messageTemplate, params object[] values)
            => Logging.Internal.Log.Warning(exception, $"[{Assembly.GetCallingAssembly().GetName().Name}] {messageTemplate}", values);
        ...
        public static void LogError(string messageTemplate, params object[] values)
            => Logging.Internal.Log.Error($"[{Assembly.GetCallingAssembly().GetName().Name}] {messageTemplate}", values);
        ...
        public static void LogError(Exception exception, string messageTemplate, params object[] values)
            => Logging.Internal.Log.Error(exception, $"[{Assembly.GetCallingAssembly().GetName().Name}] {messageTemplate}", values);
        ...
        public static void LogFatal(string messageTemplate, params object[] values)
            => Logging.Internal.Log.Fatal($"[{Assembly.GetCallingAssembly().GetName().Name}] {messageTemplate}", values);
        ...
        public static void LogFatal(Exception exception, string messageTemplate, params object[] values)
            => Logging.Internal.Log.Fatal(exception, $"[{Assembly.GetCallingAssembly().GetName().Name}] {messageTemplate}", values);

        #endregion

        #region Regular style methods
