...
public interface IDutyState : IDalamudService
{
    ...
    delegate void DutyStartedDelegate(IDutyStateEventArgs args);

    /// <summary>
    /// A delegate type used for the <see cref="DutyWiped"/> event.
    /// </summary>
    /// <param name="args">The events arguments.</param>
    delegate void DutyWipedDelegate(IDutyStateEventArgs args);

    /// <summary>
    /// A delegate type used for the <see cref="DutyRecommenced"/> event.
    /// </summary>
    /// <param name="args">The events arguments.</param>
    delegate void DutyRecommencedDelegate(IDutyStateEventArgs args);

    /// <summary>
    /// A delegate type used for the <see cref="DutyCompleted"/> event.
    /// </summary>
    /// <param name="args">The events arguments.</param>
    delegate void DutyCompletedDelegate(IDutyStateEventArgs args);
    ...
    /// </summary>
    event DutyCompletedDelegate DutyCompleted;
