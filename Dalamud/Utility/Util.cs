...
public static class Util
{
    ...
    public static bool IsWine() => Service<DalamudStartInfo>.Get().Platform != OSPlatform.Windows;
    ...
    public static OSPlatform GetHostPlatform() => Service<DalamudStartInfo>.Get().Platform;
