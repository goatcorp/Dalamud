...
internal unsafe partial class Dx11Renderer
{
    ...
    private sealed class ViewportTextureWrap : IDalamudTextureWrap, IDeferredDisposable
    {
        ...
        /// <param name="renderer">Renderer that created the viewport texture.</param>
        /// <param name="args">Arguments for creating a texture.</param>
        ...
        /// <inheritdoc/>
        public int DxgiFormat => (int)this.desc.Format;
        ...
        public void Update()
        {
            ...
            try
            {
                ...
                if (!this.args.KeepTransparency)
                {
                    ...
                    this.renderer.rectangleDrawer.StripAlpha(context.Get());
        ...
        private static ComPtr<ID3D11Texture2D> GetImGuiViewportBackBuffer(uint viewportId)
        {
            ThreadSafety.AssertMainThread();
            ...
            if (viewportId == viewports[0].ID)
            {
                ...
                {
                    ((IDXGISwapChain*)device->SwapChain->DXGISwapChain)->GetBuffer(
                            0,
                            piid,
