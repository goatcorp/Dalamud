...
namespace Dalamud.Game.ClientState.JobGauge.Types
{
    ...
    /// </summary>
    public unsafe class WARGauge : JobGaugeBase<FFXIVClientStructs.FFXIV.Client.Game.Gauge.WARGauge>
    {
        /// <summary>
        ...
        /// </summary>
        public byte BeastGaugeAmount => this.Struct->BeastGaugeAmount;
    }
}
