...
namespace Dalamud.Game.ClientState.JobGauge.Types
{
    ...
    /// </summary>
    public unsafe class DRKGauge : JobGaugeBase<FFXIVClientStructs.FFXIV.Client.Game.Gauge.DRKGauge>
    {
        /// <summary>
        ...
        /// </summary>
        public ushort DarksideTimeRemaining => this.Struct->DarksideTimeRemaining;

        /// <summary>
        /// Gets the Shadow time remaining in milliseconds.
        /// </summary>
        public ushort ShadowTimeRemaining => this.Struct->ShadowTimeRemaining;
