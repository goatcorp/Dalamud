...
namespace Dalamud.Game.ClientState.Fates
{
    ...
    public unsafe partial class Fate
    {
        ...
        /// </summary>
        public Position3 Position => new(this.Struct->X, this.Struct->Z, this.Struct->Y);

        /// <summary>
        /// Gets the territory this <see cref="Fate"/> is located in.
        /// </summary>
        public TerritoryTypeResolver TerritoryType => new(this.Struct->TerritoryID, this.dalamud);
    }
}
