...
namespace Dalamud.Game.Text.SeStringHandling
{
    ...
    public class SeStringManager
    {
        ...
        public SeString CreateItemLink(uint itemId, bool isHQ, string displayNameOverride = null)
        {
            ...
            {
                new UIForegroundPayload(data, 0x0225),
                new UIGlowPayload(data, 0x0226),
                new ItemPayload(data, itemId, isHQ),
                // arrow goes here
        ...
        {
            var mapPayload = new MapLinkPayload(Service<DataManager>.Get(), territoryId, mapId, rawX, rawY);
        ...
        {
            var mapPayload = new MapLinkPayload(Service<DataManager>.Get(), territoryId, mapId, xCoord, yCoord, fudgeFactor);
            var nameString = $"{mapPayload.PlaceName} {mapPayload.CoordinateString}";
        ...
        public List<Payload> TextArrowPayloads()
        {
            ...
            {
                new UIForegroundPayload(data, 0x01F4),
                new UIGlowPayload(data, 0x01F5),
