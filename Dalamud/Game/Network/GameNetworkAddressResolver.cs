...
internal sealed class GameNetworkAddressResolver : BaseAddressResolver
{
    ...
    protected override void Setup64Bit(TargetSigScanner targetSig)
    {
        ...
        this.ProcessZonePacketDown = targetSig.ScanText("40 53 56 48 81 EC ?? ?? ?? ?? 48 8B 05 ?? ?? ?? ?? 48 33 C4 48 89 44 24 ?? 8B F2");
        this.ProcessZonePacketUp = targetSig.ScanText("48 89 5C 24 ?? 48 89 6C 24 ?? 48 89 74 24 ?? 57 41 56 41 57 48 83 EC 70 8B 81 ?? ?? ?? ??");
    }
}
