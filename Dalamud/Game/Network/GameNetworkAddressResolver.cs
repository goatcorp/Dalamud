...
namespace Dalamud.Game.Network
{
    ...
    public sealed class GameNetworkAddressResolver : BaseAddressResolver
    {
        ...
        /// <summary>
        /// Gets the address of the ProcessCfPopPacket method.
        /// </summary>
        public IntPtr ProcessCfPopPacket { get; private set; }
        ...
        protected override void Setup64Bit(SigScanner sig)
        {
            ...
            this.ProcessCfPopPacket = sig.ScanText("40 53 57 48 83 EC 78 48 8B D9 48 8D 0D ?? ?? ?? 00 E8 ?? ?? ?? FF");
        }
    }
}
