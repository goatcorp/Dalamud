...
/// <summary>
/// A generic SigScanner usable to scan for and process signatures from any <see cref="ProcessModule"/>. 
/// </summary>
public class GenericSigScanner : ISigScanner, IDisposable
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GenericSigScanner"/> class.
    /// </summary>
    ...
    public GenericSigScanner(ProcessModule module, bool doCopy = false, FileInfo? cacheFile = null)
    {
