...
namespace Dalamud.Game.Internal.Gui.Structs
{
    ...
    internal readonly struct PartyFinderPacketStruct
    {
        /// <summary>
        /// Gets the size of this packet.
        /// </summary>
        internal static int PacketSize { get; } = Marshal.SizeOf<PartyFinderPacketStruct>();
        ...
        internal readonly PartyFinderListingStruct[] Listings;
    }
}
