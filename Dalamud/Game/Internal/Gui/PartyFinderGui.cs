...
using Dalamud.Game.Internal.Gui.PartyFinder;
...
namespace Dalamud.Game.Internal.Gui
{
    ...
    public sealed class PartyFinderGui : IDisposable
    {
        ...
        internal PartyFinderGui(SigScanner scanner, Dalamud dalamud)
        {
            ...
            this.memory = Marshal.AllocHGlobal(PartyFinderPacketStruct.PacketSize);
        ...
        private void HandleListingEvents(IntPtr data)
        {
            ...
            var packet = Marshal.PtrToStructure<PartyFinderPacketStruct>(dataPtr);
            ...
            unsafe
            {
                Buffer.MemoryCopy((void*)this.memory, (void*)dataPtr, PartyFinderPacketStruct.PacketSize, PartyFinderPacketStruct.PacketSize);
            }
        }
    }
}
