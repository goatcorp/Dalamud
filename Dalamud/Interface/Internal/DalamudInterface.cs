        ...
        if (this.isImGuiDrawDevMenu)
        {
            if (ImGui.BeginMainMenuBar())
            {
                ...
                if (ImGui.BeginMenu("Dalamud"))
                {
                    ...
                    ImGui.MenuItem($"D: {Util.GetDalamudVersion()} CS: {Util.GetGitHashClientStructs()}[{FFXIVClientStructs.ThisAssembly.Git.Commits}]", false);
                ...
                if (this.configuration.ShowDevBarInfo)
                {
                    ...
                    ImGui.BeginMenu(Util.GetDalamudVersion(), false);
