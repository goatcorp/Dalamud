...
internal unsafe class SeStringRendererTestWidget : IDataWindowWidget
{
    ...
    public void Draw()
    {
        ...
        {
            fixed (byte* p = Service<SeStringRenderer>.Get().Compile(this.testString).Data.Span)
        ...
        ImGui.Separator();
        var test = ImGuiHelpers.CompileSeStringWrapped(this.testString, this.style, new("test"));
