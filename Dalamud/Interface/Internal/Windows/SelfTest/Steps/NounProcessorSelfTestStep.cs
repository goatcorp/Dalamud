...
internal class NounProcessorSelfTestStep : ISelfTestStep
{
    ...
    [
        ...
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.German, 1, (int)GermanArticleType.Definite, (int)GermanCases.Nominative, "der Met schleppende Wiesländer"),
        ...
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.German, 1, (int)GermanArticleType.Possessive, (int)GermanCases.Nominative, "dein Met schleppender Wiesländer"),
        ...
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.German, 2, (int)GermanArticleType.Indefinite, (int)GermanCases.Nominative, "2 Met schleppende Wiesländer"),
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.German, 2, (int)GermanArticleType.Indefinite, (int)GermanCases.Genitive, "2 Met schleppender Wiesländer"),
        ...
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.German, 2, (int)GermanArticleType.Indefinite, (int)GermanCases.Accusative, "2 Met schleppende Wiesländer"),
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.German, 2, (int)GermanArticleType.Definite, (int)GermanCases.Nominative, "die Met schleppenden Wiesländer"),
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.German, 2, (int)GermanArticleType.Definite, (int)GermanCases.Genitive, "der Met schleppenden Wiesländer"),
        ...
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.German, 2, (int)GermanArticleType.Definite, (int)GermanCases.Accusative, "die Met schleppenden Wiesländer"),
        ...
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.French, 1, (int)FrenchArticleType.Demonstrative, 1, "ce livreur d'hydromel"),
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.French, 1, (int)FrenchArticleType.Prepositionà, 1, "au livreur d'hydromel"),
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.French, 1, (int)FrenchArticleType.Prepositionde, 1, "de livreur d'hydromel"),
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.French, 1, (int)FrenchArticleType.Partitive, 1, "du livreur d'hydromel"),
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.French, 1, (int)FrenchArticleType.Conjunction, 1, "que livreur d'hydromel"),
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.French, 1, (int)FrenchArticleType.ZeroArticle, 1, "livreur d'hydromel"),
        ...
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.French, 2, (int)FrenchArticleType.Demonstrative, 1, "ces livreurs d'hydromel"),
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.French, 2, (int)FrenchArticleType.Prepositionà, 1, "aux livreurs d'hydromel"),
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.French, 2, (int)FrenchArticleType.Prepositionde, 1, "de livreurs d'hydromel"),
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.French, 2, (int)FrenchArticleType.Partitive, 1, "des livreurs d'hydromel"),
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.French, 2, (int)FrenchArticleType.Conjunction, 1, "que livreurs d'hydromel"),
        new(nameof(LSheets.BNpcName), 1330, ClientLanguage.French, 2, (int)FrenchArticleType.ZeroArticle, 1, "livreurs d'hydromel"),

        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 1, (int)FrenchArticleType.Indefinite, 1, "Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 1, (int)FrenchArticleType.Definite, 1, "Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 1, (int)FrenchArticleType.PossessiveFirstPerson, 1, "mon Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 1, (int)FrenchArticleType.PossessiveSecondPerson, 1, "ton Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 1, (int)FrenchArticleType.PossessiveThirdPerson, 1, "son Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 1, (int)FrenchArticleType.Demonstrative, 1, "cette Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 1, (int)FrenchArticleType.Prepositionà, 1, "à Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 1, (int)FrenchArticleType.Prepositionde, 1, "d'Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 1, (int)FrenchArticleType.Partitive, 1, "d'Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 1, (int)FrenchArticleType.Conjunction, 1, "qu'Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 1, (int)FrenchArticleType.ZeroArticle, 1, "Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 2, (int)FrenchArticleType.Indefinite, 1, "Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 2, (int)FrenchArticleType.Definite, 1, "Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 2, (int)FrenchArticleType.PossessiveFirstPerson, 1, "mon Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 2, (int)FrenchArticleType.PossessiveSecondPerson, 1, "ton Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 2, (int)FrenchArticleType.PossessiveThirdPerson, 1, "son Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 2, (int)FrenchArticleType.Demonstrative, 1, "cette Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 2, (int)FrenchArticleType.Prepositionà, 1, "à Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 2, (int)FrenchArticleType.Prepositionde, 1, "d'Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 2, (int)FrenchArticleType.Partitive, 1, "d'Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 2, (int)FrenchArticleType.Conjunction, 1, "qu'Eos"),
        new(nameof(LSheets.BNpcName), 1398, ClientLanguage.French, 2, (int)FrenchArticleType.ZeroArticle, 1, "Eos"),
        ...
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 1, (int)FrenchArticleType.Indefinite, 1, "une occultiste studieuse"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 1, (int)FrenchArticleType.Definite, 1, "l'occultiste studieuse"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 1, (int)FrenchArticleType.PossessiveFirstPerson, 1, "mon occultiste studieuse"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 1, (int)FrenchArticleType.PossessiveSecondPerson, 1, "ton occultiste studieuse"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 1, (int)FrenchArticleType.PossessiveThirdPerson, 1, "son occultiste studieuse"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 1, (int)FrenchArticleType.Demonstrative, 1, "cette occultiste studieuse"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 1, (int)FrenchArticleType.Prepositionà, 1, "à l'occultiste studieuse"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 1, (int)FrenchArticleType.Prepositionde, 1, "d'occultiste studieuse"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 1, (int)FrenchArticleType.Partitive, 1, "de l'occultiste studieuse"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 1, (int)FrenchArticleType.Conjunction, 1, "qu'occultiste studieuse"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 1, (int)FrenchArticleType.ZeroArticle, 1, "occultiste studieuse"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 2, (int)FrenchArticleType.Indefinite, 1, "des occultistes studieuses"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 2, (int)FrenchArticleType.Definite, 1, "les occultistes studieuses"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 2, (int)FrenchArticleType.PossessiveFirstPerson, 1, "mes occultistes studieuses"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 2, (int)FrenchArticleType.PossessiveSecondPerson, 1, "tes occultistes studieuses"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 2, (int)FrenchArticleType.PossessiveThirdPerson, 1, "ses occultistes studieuses"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 2, (int)FrenchArticleType.Demonstrative, 1, "ces occultistes studieuses"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 2, (int)FrenchArticleType.Prepositionà, 1, "aux occultistes studieuses"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 2, (int)FrenchArticleType.Prepositionde, 1, "d'occultistes studieuses"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 2, (int)FrenchArticleType.Partitive, 1, "des occultistes studieuses"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 2, (int)FrenchArticleType.Conjunction, 1, "que occultistes studieuses"),
        new(nameof(LSheets.ENpcResident), 1031967, ClientLanguage.French, 2, (int)FrenchArticleType.ZeroArticle, 1, "occultistes studieuses"),
        ...
        new(nameof(LSheets.Item), 44348, ClientLanguage.German, 1, (int)GermanArticleType.Definite, (int)GermanCases.Nominative, "der ungewöhnliche Allagische Stein der Phantasmagorie"),
        ...
        new(nameof(LSheets.Item), 44348, ClientLanguage.German, 1, (int)GermanArticleType.Possessive, (int)GermanCases.Nominative, "dein ungewöhnlicher Allagischer Stein der Phantasmagorie"),
        ...
        new(nameof(LSheets.Item), 44348, ClientLanguage.German, 2, (int)GermanArticleType.Indefinite, (int)GermanCases.Nominative, "2 ungewöhnliche Allagische Steine der Phantasmagorie"),
        new(nameof(LSheets.Item), 44348, ClientLanguage.German, 2, (int)GermanArticleType.Indefinite, (int)GermanCases.Genitive, "2 ungewöhnlicher Allagischer Steine der Phantasmagorie"),
        ...
        new(nameof(LSheets.Item), 44348, ClientLanguage.German, 2, (int)GermanArticleType.Indefinite, (int)GermanCases.Accusative, "2 ungewöhnliche Allagische Steine der Phantasmagorie"),
        new(nameof(LSheets.Item), 44348, ClientLanguage.German, 2, (int)GermanArticleType.Definite, (int)GermanCases.Nominative, "die ungewöhnlichen Allagischen Steine der Phantasmagorie"),
        new(nameof(LSheets.Item), 44348, ClientLanguage.German, 2, (int)GermanArticleType.Definite, (int)GermanCases.Genitive, "der ungewöhnlichen Allagischen Steine der Phantasmagorie"),
        ...
        new(nameof(LSheets.Item), 44348, ClientLanguage.German, 2, (int)GermanArticleType.Definite, (int)GermanCases.Accusative, "die ungewöhnlichen Allagischen Steine der Phantasmagorie"),
        ...
        new(nameof(LSheets.Item), 44348, ClientLanguage.French, 1, (int)FrenchArticleType.Demonstrative, 1, "ce mémoquartz inhabituel fantasmagorique"),
        new(nameof(LSheets.Item), 44348, ClientLanguage.French, 1, (int)FrenchArticleType.Prepositionà, 1, "au mémoquartz inhabituel fantasmagorique"),
        new(nameof(LSheets.Item), 44348, ClientLanguage.French, 1, (int)FrenchArticleType.Prepositionde, 1, "de mémoquartz inhabituel fantasmagorique"),
        new(nameof(LSheets.Item), 44348, ClientLanguage.French, 1, (int)FrenchArticleType.Partitive, 1, "du mémoquartz inhabituel fantasmagorique"),
        new(nameof(LSheets.Item), 44348, ClientLanguage.French, 1, (int)FrenchArticleType.Conjunction, 1, "que mémoquartz inhabituel fantasmagorique"),
        new(nameof(LSheets.Item), 44348, ClientLanguage.French, 1, (int)FrenchArticleType.ZeroArticle, 1, "mémoquartz inhabituel fantasmagorique"),
        ...
        new(nameof(LSheets.Item), 44348, ClientLanguage.French, 2, (int)FrenchArticleType.Demonstrative, 1, "ces mémoquartz inhabituels fantasmagoriques"),
        new(nameof(LSheets.Item), 44348, ClientLanguage.French, 2, (int)FrenchArticleType.Prepositionà, 1, "aux mémoquartz inhabituels fantasmagoriques"),
        new(nameof(LSheets.Item), 44348, ClientLanguage.French, 2, (int)FrenchArticleType.Prepositionde, 1, "de mémoquartz inhabituels fantasmagoriques"),
        new(nameof(LSheets.Item), 44348, ClientLanguage.French, 2, (int)FrenchArticleType.Partitive, 1, "des mémoquartz inhabituels fantasmagoriques"),
        new(nameof(LSheets.Item), 44348, ClientLanguage.French, 2, (int)FrenchArticleType.Conjunction, 1, "que mémoquartz inhabituels fantasmagoriques"),
        new(nameof(LSheets.Item), 44348, ClientLanguage.French, 2, (int)FrenchArticleType.ZeroArticle, 1, "mémoquartz inhabituels fantasmagoriques"),
