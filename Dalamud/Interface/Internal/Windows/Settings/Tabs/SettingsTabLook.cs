...
public class SettingsTabLook : SettingsTab
{
    ...
    public override SettingsEntry[] Entries { get; } =
    {
        ...
        new SettingsEntry<bool>(
            Loc.Localize("DalamudSettingEnablePluginUISoundEffects", "Enable plugin UI sound effects"),
            Loc.Localize("DalamudSettingEnablePluginUISoundEffectsHint", "This will allow you to enable or disable sound effects generated by plugin user interfaces.\nThis setting is effected by your in-game `System Sounds` setting and volume."),
            c => c.PluginUISoundEffects,
            (v, c) => c.PluginUISoundEffects = v),
