...
internal readonly ref struct TsDataSpan
{
    ...
    public readonly ReadOnlySpan<ISpannableTemplate?> Children;

    /// <summary>Initializes a new instance of the <see cref="TsDataSpan"/> struct.</summary>
    ...
    public TsDataSpan(
        ...
        ReadOnlySpan<ISpannableTemplate?> children)
    {
    ...
    /// <summary>Initializes a new instance of the <see cref="TsDataSpan"/> struct.</summary>
    /// <param name="textStream">The text data.</param>
    public TsDataSpan(ReadOnlySpan<byte> textStream) => this.TextStream = textStream;

    /// <summary>Gets the offset past the last text and span record.</summary>
    public TsCompositeOffset EndOffset => new(this.TextStream.Length, this.Records.Length);
    ...
    public bool TryGetSpannableAt(int index, [NotNullWhen(true)] out ISpannableTemplate? spannable)
    {
        spannable = index < 0 || index >= this.Children.Length ? default : this.Children[index];
    ...
    public ref struct Segment
    {
        ...
        /// <param name="recordIndex">The record index.</param>
        public Segment(TsDataSpan data, int textOffset, int recordIndex)
        {
            this.Data = data;
    ...
    /// <summary>Enumerator for <see cref="TsDataSpan"/>.</summary>
    public ref struct Enumerator
    {
        /// <summary>Initializes a new instance of the <see cref="Enumerator"/> struct.</summary>
        /// <param name="data">The data.</param>
        public Enumerator(TsDataSpan data) => this.Current = new(data, -1, -1);
