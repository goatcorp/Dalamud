      ...
      ITextureReadbackProvider
{
    ...
    private TextureManager(InterfaceManager.InterfaceManagerWithScene withScene)
    {
        ...
        this.scene = withScene.Manager.Scene ?? throw new InvalidOperationException("scene must have been initialized");
    ...
    public IDalamudTextureWrap CreateEmpty(
        ...
        string? debugName = null)
    {
        var wrap = this.scene.TextureManager.Create(
            default,
            specs,
            cpuRead,
            cpuWrite,
    ...
    public bool IsDxgiFormatSupported(int dxgiFormat) =>
        this.scene.TextureManager.IsDxgiFormatSupported(dxgiFormat);
    ...
    internal IDalamudTextureWrap NoThrottleCreateFromRaw(
        ...
        ReadOnlySpan<byte> bytes)
    {
        var wrap = this.scene.TextureManager.Create(bytes, specs, false, false, true);
