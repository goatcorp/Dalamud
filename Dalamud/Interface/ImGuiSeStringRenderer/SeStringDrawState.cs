...
public unsafe ref struct SeStringDrawState : IDisposable
{
    ...
    /// <inheritdoc/>
    public void Dispose() =>
        ImGuiNative.ImDrawListSplitter_ClearFreeMemory((ImDrawListSplitter*)Unsafe.AsPointer(ref this.splitter));
    ...
    public void SetCurrentChannel(SeStringDrawChannel channelIndex) =>
        ImGuiNative.ImDrawListSplitter_SetCurrentChannel(
            (ImDrawListSplitter*)Unsafe.AsPointer(ref this.splitter),
            this.drawList,
            (int)channelIndex);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal void MergeDrawList() => ImGuiNative.ImDrawListSplitter_Merge(
        (ImDrawListSplitter*)Unsafe.AsPointer(ref this.splitter),
        this.drawList);
}
