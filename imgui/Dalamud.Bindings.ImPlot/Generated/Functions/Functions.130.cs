...
namespace Dalamud.Bindings.ImPlot
{
	public unsafe partial class ImPlot
	{
		...
		internal static byte ColormapSliderNative(byte* label, float* t, Vector4* output, byte* format, ImPlotColormap cmap)
		{
			...
			return ((delegate* unmanaged[Cdecl]<byte*, float*, Vector4*, byte*, ImPlotColormap, byte>)funcTable[331])(label, t, output, format, cmap);
			#else
			return (byte)((delegate* unmanaged[Cdecl]<nint, nint, nint, nint, ImPlotColormap, byte>)funcTable[331])((nint)label, (nint)t, (nint)output, (nint)format, cmap);
			#endif
		}
