...
namespace Dalamud.Bindings.ImPlot
{
	public unsafe partial class ImPlot
	{
		...
		internal static void PlotStemsNative(byte* labelId, uint* values, int count, double reference, double scale, double start, ImPlotStemsFlags flags, int offset, int stride)
		{
			...
			((delegate* unmanaged[Cdecl]<byte*, uint*, int, double, double, double, ImPlotStemsFlags, int, int, void>)funcTable[187])(labelId, values, count, reference, scale, start, flags, offset, stride);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, int, double, double, double, ImPlotStemsFlags, int, int, void>)funcTable[187])((nint)labelId, (nint)values, count, reference, scale, start, flags, offset, stride);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			((delegate* unmanaged[Cdecl]<byte*, long*, int, double, double, double, ImPlotStemsFlags, int, int, void>)funcTable[188])(labelId, values, count, reference, scale, start, flags, offset, stride);
			#else
			((delegate* unmanaged[Cdecl]<nint, nint, int, double, double, double, ImPlotStemsFlags, int, int, void>)funcTable[188])((nint)labelId, (nint)values, count, reference, scale, start, flags, offset, stride);
			#endif
		}
