...
namespace Dalamud.Bindings.ImPlot
{
	public unsafe partial class ImPlot
	{
		...
		internal static double PlotHistogramNative(byte* labelId, double* values, int count, int bins, double barScale, ImPlotRange range, ImPlotHistogramFlags flags)
		{
			...
			return ((delegate* unmanaged[Cdecl]<byte*, double*, int, int, double, ImPlotRange, ImPlotHistogramFlags, double>)funcTable[227])(labelId, values, count, bins, barScale, range, flags);
			#else
			return (double)((delegate* unmanaged[Cdecl]<nint, nint, int, int, double, ImPlotRange, ImPlotHistogramFlags, double>)funcTable[227])((nint)labelId, (nint)values, count, bins, barScale, range, flags);
			#endif
		}
		...
		{
			#if NET5_0_OR_GREATER
			return ((delegate* unmanaged[Cdecl]<byte*, byte*, int, int, double, ImPlotRange, ImPlotHistogramFlags, double>)funcTable[228])(labelId, values, count, bins, barScale, range, flags);
			#else
			return (double)((delegate* unmanaged[Cdecl]<nint, nint, int, int, double, ImPlotRange, ImPlotHistogramFlags, double>)funcTable[228])((nint)labelId, (nint)values, count, bins, barScale, range, flags);
			#endif
		}
