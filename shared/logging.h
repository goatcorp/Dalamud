...
namespace logging {
    ...
    /**
     * @brief Sets the tag string used in log output (e.g. "BOOT", "CRASHHANDLER").
     * Defaults to "CPP". Maximum 15 characters; longer strings are truncated.
     */
    void set_tag(const char* tag);

    /**
     * @brief Marks this DLL either as loaded or unloaded, to prevent accessing handles when the DLL is not loaded.
     */
